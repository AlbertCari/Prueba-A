/* =========================================================
   ...
   - NO borra background-image (solo background-color en contenedores tipo “card” si fuese necesario)
...
(function () {
  ...
  /* ---------- FONDO: aplicar según orientación y ruta correcta en GitHub Pages ---------- */
  function setResponsivePageBackground() {
    ...
    var apply = function(){
      ...
      // No tocamos otras propiedades, solo la imagen (CSS define cover/center)
  ...
  /* ---------- Botones “X años” (defensivo si aparecieran sueltos) ---------- */
  ...
  /* ---------- Limpieza segura de “cards” de íconos (si existieran) ---------- */
  ...
  /* ---------- Lanzamiento ---------- */
  onReady(function () {
    setResponsivePageBackground();  // <— bg-landscape.png / bg-portrait.png
    initVideoEmbeds();
    unifyAgeButtons();
